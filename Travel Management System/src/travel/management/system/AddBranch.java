...
public class AddBranch extends JFrame {
	...
	public AddBranch(String username) {
		...
		JLabel lblName = new JLabel("ADD BRANCH");
		...
		contentPane.add(l1);
                ...
                JLabel lblId = new JLabel("Select Branch Type :");
		...
		contentPane.add(lblId);
                ...
                JLabel la3 = new JLabel("Total Volume");
		...
		t1.setColumns(10);
                ...
                JLabel la4 = new JLabel("Number of trucks");
		...
		JLabel la5 = new JLabel("Truck / Small");
		...
		JLabel lblDeposite = new JLabel("Total set up cost :");
		...
		contentPane.add(l5);
                ...
                JButton b1 = new JButton("Check cost");
		b1.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            ...
                            ResultSet rs = c4.s.executeQuery(q1);
                            if(rs.next()){
                                ...
                                if(persons * days > 0) {
                                    int total = 0;
                                    total += acprice.equals("large") ? ac : 1;
