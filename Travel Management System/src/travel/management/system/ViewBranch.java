...
public class ViewBranch extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewBranch frame = new ViewBranch("");
	...
	public ViewBranch(String username)  {
		...
		JLabel lblName = new JLabel("VIEW BRANCH DETAILS");
		...
		JLabel lblGender = new JLabel("Large/Small :");
